...
var grammar = {
  ...
  functionExpression: [
    o('( ) FUNC_EXPRESSION block', function () {
      return new FunctionExpression([], $4);
    }),
    o('( functionDeclarationArguments ) FUNC_EXPRESSION block', function () {
      return new FunctionExpression($2, $5);
    }),
    o('( ) FUNC_EXPRESSION expression', function () {
      return new FunctionExpression([], $4);
    }, { "prec": "FUNC" }),
    o('( functionDeclarationArguments ) FUNC_EXPRESSION expression', function () {
      return new FunctionExpression($2, $5);
    }, { "prec": "FUNC" }),    
  ],
