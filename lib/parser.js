module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c220 = function(init, test, body) {
              return new ast.ForStatement(
        ...
        peg$c221 = function(declarations, test, update, body) {
              return new ast.ForStatement(
                new ast.VariableDeclarationStatement(declarations),
                extractOptional(test, 0),
                update,
        ...
        peg$c222 = function(init, test, update, body) {
              return new ast.ForStatement(
                extractOptional(init, 0),
                extractOptional(test, 0),
                update,
        ...
        peg$c223 = function(identifiers) { return new ast.UseStatement(identifiers) },
        peg$c224 = ":",
        peg$c225 = { type: "literal", value: ":", description: "\":\"" },
        peg$c226 = function(id) {
            return id.asPredefinedCollection();
          },
        peg$c227 = function(expression) {
              return insertLocationData(new ast.ExpressionStatement(expression), text(), line(), column());
            },
        peg$c228 = function(left, operator, right) { return insertLocationData(new ast.AssignmentExpression(left, operator, right), text(), line(), column()); },
        ...
        peg$c252 = function(consequent, condition) {
              if (condition) {
        ...
        peg$c253 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c254 = "||",
        ...
        peg$c260 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c261 = "|",
        ...
        peg$c285 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c286 = "<<",
        ...
        peg$c323 = function(argument, operator) {
              if (operator) {
        ...
        peg$c326 = function(argument, operator) {
            if (operator) { 
        ...
        peg$c327 = function(callee, nullPropagatingOperator, args) {
        ...
        peg$c328 = function(nullPropagatingOperator, args) {
                  return { 
        ...
        peg$c334 = function(range) {
                return {
                  type: "RangeMemberExpression",
                  range: range   
                }
              },
        peg$c335 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c340 = function(nullPropagatingOperator, property) {
                  return { 
                    type: nullPropagatingOperator === "?" ? "NullPropagatingExpression" : "MemberExpression",
                    property: property, 
                    computed: false 
        ...
        peg$c342 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c343 = function(expression) {
            return insertLocationData(new ast.SplatExpression(expression), text(), line(), column()); 
          },
        peg$c344 = function(id, params, inheritsFrom, body) {
        ...
        peg$c351 = function(id) { return id.asGlobal(); },
        peg$c352 = function() {
        ...
        peg$c354 = function(range) {
            return range;
          },
        peg$c355 = function(from, operator, to) {
        ...
        peg$c362 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c363 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c364 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c365 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c366 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c367 = function(key, value) {
              return insertLocationData(new ast.Property(key, value), text(), line(), column());
            },
        peg$c368 = function(id) { return [id]; },
