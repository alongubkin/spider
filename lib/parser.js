module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c188 = function(declarations) {
        ...
        peg$c195 = function(expression) { return expression; },
        peg$c196 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c197 = "extends",
        peg$c198 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c199 = function(call) {
              return call;
            },
        peg$c200 = function(id) {
              return insertLocationData(
        ...
        peg$c204 = function(id, defaultValue) {
        ...
        peg$c217 = function(init, test, body) {
              return new ast.ForStatement(
        ...
        peg$c218 = function(declarations, test, update, body) {
              return new ast.ForStatement(
                new ast.VariableDeclarationStatement(declarations),
                extractOptional(test, 0),
                update,
        ...
        peg$c219 = function(init, test, update, body) {
              return new ast.ForStatement(
                extractOptional(init, 0),
                extractOptional(test, 0),
                update,
        ...
        peg$c220 = function(identifiers) { return new ast.UseStatement(identifiers) },
        peg$c221 = ":",
        peg$c222 = { type: "literal", value: ":", description: "\":\"" },
        peg$c223 = function(id) {
            return id.asPredefinedCollection();
          },
        peg$c224 = function(expression) {
              return insertLocationData(new ast.ExpressionStatement(expression), text(), line(), column());
            },
        peg$c225 = function(left, operator, right) { return insertLocationData(new ast.AssignmentExpression(left, operator, right), text(), line(), column()); },
        ...
        peg$c256 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c257 = "|",
        ...
        peg$c281 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c282 = "<<",
        ...
        peg$c312 = function(operator, argument) {
        ...
        peg$c319 = function(argument, operator) {
              if (operator) {
        ...
        peg$c322 = function(argument, operator) {
            if (operator) { 
        ...
        peg$c323 = function(callee, nullPropagatingOperator, args) {
        ...
        peg$c324 = function(nullPropagatingOperator, args) {
                  return { 
        ...
        peg$c330 = function(range) {
                return {
                  type: "RangeMemberExpression",
                  range: range   
                }
              },
        peg$c331 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c336 = function(nullPropagatingOperator, property) {
                  return { 
                    type: nullPropagatingOperator === "?" ? "NullPropagatingExpression" : "MemberExpression",
                    property: property, 
                    computed: false 
        ...
        peg$c338 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c339 = function(id, params, inheritsFrom, body) {
        ...
        peg$c346 = function(id) { return id.asGlobal(); },
        peg$c347 = function() {
        ...
        peg$c350 = function(from, operator, to) {
        ...
        peg$c359 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c360 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c361 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c362 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c363 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c364 = function(key, value) {
              return insertLocationData(new ast.Property(key, value), text(), line(), column());
            },
        peg$c365 = function(id) { return [id]; },
