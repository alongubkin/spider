module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c338 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c339 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c340 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c341 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c342 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c343 = function(key, value) {
