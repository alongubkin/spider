module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c234 = function(declarations, test, update, body) {
        ...
        peg$c235 = function(init, test, update, body) {
              return insertLocationData(new ast.ForStatement(
        ...
        peg$c300 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c301 = "<<",
        ...
        peg$c331 = function(operator, argument) {
        ...
        peg$c338 = function(argument, operator) {
              if (operator) {
        ...
        peg$c342 = function(callee, nullPropagatingOperator, args) {
        ...
        peg$c343 = function(nullPropagatingOperator, args) {
                  return { 
        ...
        peg$c349 = function(range) {
                return {
                  type: "RangeMemberExpression",
                  range: range   
                }
              },
        peg$c350 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c355 = function(nullPropagatingOperator, property) {
                  return { 
                    type: nullPropagatingOperator === "?" ? "NullPropagatingExpression" : "MemberExpression",
                    property: property, 
                    computed: false 
        ...
        peg$c357 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c358 = function(expression) {
            return insertLocationData(new ast.SplatExpression(expression), text(), line(), column()); 
          },
        peg$c359 = function(id, params, inheritsFrom, body) {
        ...
        peg$c366 = function(id) { return id.asGlobal(); },
        peg$c367 = function() {
        ...
        peg$c369 = function(range) {
            return range;
          },
        peg$c370 = function(from, operator, to) {
        ...
        peg$c377 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c378 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c379 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c380 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c381 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c382 = function(key, value) {
              return insertLocationData(new ast.Property(key, value), text(), line(), column());
            },
        peg$c383 = function(id) { return [id]; },
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (s4 !== peg$FAILED) {
          ...
          if (s5 !== peg$FAILED) {
            s6 = peg$parse__();
            if (s6 !== peg$FAILED) {
              s7 = peg$parseNullCoalescingExpression();
              if (s7 !== peg$FAILED) {
                s4 = [s4, s5, s6, s7];
                s3 = s4;
              } else {
