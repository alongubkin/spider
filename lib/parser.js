module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c198 = function(declarations) {
        ...
        peg$c205 = function(expression) { return expression; },
        peg$c206 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c207 = "extends",
        peg$c208 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c209 = function(call) {
              return call;
            },
        peg$c210 = function(id) {
              return insertLocationData(
        ...
        peg$c213 = function(id) {
              return insertLocationData(
                new ast.CallExpression(id.asGlobal(), []),
                text(), line(), column());
            },
        peg$c214 = function(id, defaultValue) {
        ...
        peg$c235 = function(key, value, object, body) {
        ...
        peg$c236 = function(declarations, test, update, body) {
        ...
        peg$c237 = function(init, test, update, body) {
              return insertLocationData(new ast.ForStatement(
        ...
        peg$c238 = function(identifiers) { return new ast.UseStatement(identifiers) },
        peg$c239 = ":",
        ...
        peg$c243 = function(left, operator, right) { return insertLocationData(new ast.AssignmentExpression(left, operator, right), text(), line(), column()); },
        ...
        peg$c267 = function(consequent, condition) {
              if (condition) {
        ...
        peg$c268 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c269 = "||",
        ...
        peg$c275 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c276 = "|",
        ...
        peg$c301 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c302 = "<<",
        ...
        peg$c310 = /^[+=]/,
        peg$c311 = { type: "class", value: "[+=]", description: "[+=]" },
        peg$c312 = "-",
        ...
        peg$c332 = function(operator, argument) {
        ...
        peg$c339 = function(argument, operator) {
              if (operator) {
        ...
        peg$c342 = function(argument, operator) {
            if (operator) { 
        ...
        peg$c343 = function(callee, nullPropagatingOperator, args) {
        ...
        peg$c344 = function(nullPropagatingOperator, args) {
                  return { 
        ...
        peg$c350 = function(range) {
                return {
                  type: "RangeMemberExpression",
                  range: range   
                }
              },
        peg$c351 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c356 = function(nullPropagatingOperator, property) {
                  return { 
                    type: nullPropagatingOperator === "?" ? "NullPropagatingExpression" : "MemberExpression",
                    property: property, 
                    computed: false 
        ...
        peg$c367 = function(id) { return id.asGlobal(); },
        peg$c368 = function() {
        ...
        peg$c370 = function(range) {
            return range;
          },
        peg$c371 = function(from, operator, to) {
        ...
        peg$c377 = function(elements, elision) {
        ...
        peg$c378 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c379 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c380 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c381 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c382 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c383 = function(key, value) {
              return insertLocationData(new ast.Property(key, value), text(), line(), column());
            },
        peg$c384 = function(id) { return [id]; },
