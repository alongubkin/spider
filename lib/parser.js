module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c192 = function(declarations) {
        ...
        peg$c199 = function(expression) { return expression; },
        peg$c200 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c201 = "extends",
        peg$c202 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c203 = function(call) {
              return call;
            },
        ...
        peg$c207 = function(id) {
              return insertLocationData(
                new ast.CallExpression(id.asGlobal(), []),
                text(), line(), column());
            },
        peg$c208 = function(id, defaultValue) {
        ...
        peg$c214 = function(test, consequent) {
        ...
        peg$c224 = function(init, test, update, body) {
              return insertLocationData(new ast.ForStatement(
        ...
        peg$c225 = function(item, index, array, body) {
        ...
        peg$c226 = function(key, value, object, body) {
        ...
        peg$c227 = function(identifiers) { return new ast.UseStatement(identifiers) },
        peg$c228 = ":",
        peg$c229 = { type: "literal", value: ":", description: "\":\"" },
        peg$c230 = function(id) {
            return id.asPredefinedCollection();
          },
        peg$c231 = function(expression) {
              return insertLocationData(new ast.ExpressionStatement(expression), text(), line(), column());
            },
        peg$c232 = function(left, operator, right) { return insertLocationData(new ast.AssignmentExpression(left, operator, right), text(), line(), column()); },
        ...
        peg$c256 = function(consequent, condition) {
              if (condition) {
        ...
        peg$c257 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c258 = "||",
        ...
        peg$c264 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c265 = "|",
        ...
        peg$c289 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c290 = "<<",
        ...
        peg$c320 = function(operator, argument) {
        ...
        peg$c327 = function(argument, operator) {
              if (operator) {
        ...
        peg$c330 = function(argument, operator) {
            if (operator) { 
        ...
        peg$c331 = function(callee, nullPropagatingOperator, args) {
        ...
        peg$c332 = function(nullPropagatingOperator, args) {
                  return { 
        ...
        peg$c338 = function(range) {
                return {
                  type: "RangeMemberExpression",
                  range: range   
                }
              },
        peg$c339 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c344 = function(nullPropagatingOperator, property) {
                  return { 
                    type: nullPropagatingOperator === "?" ? "NullPropagatingExpression" : "MemberExpression",
                    property: property, 
                    computed: false 
        ...
        peg$c355 = function(id) { return id.asGlobal(); },
        peg$c356 = function() {
        ...
        peg$c358 = function(range) {
            return range;
          },
        peg$c359 = function(from, operator, to) {
        ...
        peg$c365 = function(elements, elision) {
        ...
        peg$c366 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c367 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c368 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c369 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c370 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c371 = function(key, value) {
              return insertLocationData(new ast.Property(key, value), text(), line(), column());
            },
        peg$c372 = function(id) { return [id]; },
