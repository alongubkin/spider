module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c199 = "not",
        peg$c200 = { type: "literal", value: "not", description: "\"not\"" },
        peg$c201 = ";",
        peg$c202 = { type: "literal", value: ";", description: "\";\"" },
        peg$c203 = function(body) {
        ...
        peg$c217 = function(expression) { return expression; },
        peg$c218 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c219 = "extends",
        peg$c220 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c221 = function(call) {
              return call;
            },
        ...
        peg$c250 = function(item, index, array, body) {
        ...
        peg$c251 = function(key, value, object, body) {
        ...
        peg$c252 = function(declarations, test, update, body) {
        ...
        peg$c253 = function(init, test, update, body) {
              return insertLocationData(new ast.ForStatement(
        ...
        peg$c254 = function(identifiers) { return new ast.UseStatement(identifiers) },
        peg$c255 = function(id) {
            return id.asPredefinedCollection();
          },
        peg$c256 = function(expression) {
              return insertLocationData(new ast.ExpressionStatement(expression), text(), line(), column());
            },
        peg$c257 = function(left, assignment) { 
              if (!assignment) {
                return left;
              }
        ...
        peg$c281 = function(consequent, condition) {
              if (condition) {
        ...
        peg$c282 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c283 = "||",
        ...
        peg$c289 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c290 = "|",
        ...
        peg$c315 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c316 = "<<",
        ...
        peg$c346 = function(operator, argument) {
        ...
        peg$c357 = function(argument, operator) {
            if (operator) { 
        ...
        peg$c359 = function(nullPropagatingOperator, args) {
                  return { 
        ...
        peg$c365 = function(range) {
                return {
                  type: "RangeMemberExpression",
                  range: range   
                }
              },
        peg$c366 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c370 = function(nullPropagatingOperator, property) {
                  return { 
                    type: nullPropagatingOperator === "?" ? "NullPropagatingExpression" : "MemberExpression",
                    property: property, 
                    computed: false 
        ...
        peg$c375 = function(params, operator, body) {      
              return new ast.FunctionExpression(
                null,
                optionalList(extractOptional(params, 0)),
                body,
        ...
        peg$c376 = function(params, operator, body) {
              return new ast.FunctionExpression(
                null, 
                optionalList(extractOptional(params, 0)),
                body,
        ...
        peg$c381 = function(expression, item, index, array, condition) {
        ...
        peg$c384 = function(id) { return id.asGlobal(); },
        peg$c385 = function() {
        ...
        peg$c387 = function(range) {
            return range;
          },
        peg$c388 = function(from, operator, to) {
        ...
        peg$c395 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c396 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c397 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c398 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c399 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c400 = function(key, value) {
              return insertLocationData(new ast.Property(key, value), text(), line(), column());
            },
        peg$c401 = function(id) { return [id]; },
