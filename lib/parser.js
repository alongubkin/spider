module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c369 = function(id) { return id.asGlobal(); },
        peg$c370 = function() {
        ...
        peg$c372 = function(range) {
            return range;
          },
        peg$c373 = function(from, operator, to) {
        ...
        peg$c379 = function(elements, elision) {
        ...
        peg$c380 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c381 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c382 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c383 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c384 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c385 = function(key, value) {
              return insertLocationData(new ast.Property(key, value), text(), line(), column());
            },
        peg$c386 = function(id) { return [id]; },
