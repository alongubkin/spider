module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c215 = function(init, test, body) {
              return new ast.ForStatement(
        ...
        peg$c216 = function(declarations, test, update, body) {
              return new ast.ForStatement(
                new ast.VariableDeclarationStatement(declarations),
                extractOptional(test, 0),
                update,
        ...
        peg$c217 = function(init, test, update, body) {
              return new ast.ForStatement(
                extractOptional(init, 0),
                extractOptional(test, 0),
                update,
        ...
        peg$c218 = function(identifiers) { return new ast.UseStatement(identifiers) },
        peg$c219 = ":",
        ...
        peg$c223 = function(left, operator, right) { return insertLocationData(new ast.AssignmentExpression(left, operator, right), text(), line(), column()); },
        ...
        peg$c247 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c248 = "||",
        ...
        peg$c254 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c255 = "|",
        ...
        peg$c279 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c280 = "<<",
        ...
        peg$c310 = function(operator, argument) {
        ...
        peg$c317 = function(argument, operator) {
              if (operator) {
        ...
        peg$c320 = function(argument, operator) {
            if (operator) { 
        ...
        peg$c321 = function(callee, nullPropagatingOperator, args) {
        ...
        peg$c322 = function(nullPropagatingOperator, args) {
                  return { 
        ...
        peg$c328 = function(range) {
                return {
                  type: "RangeMemberExpression",
                  range: range   
                }
              },
        peg$c329 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c336 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c337 = function(id, params, inheritsFrom, body) {
        ...
        peg$c344 = function(id) { return id.asGlobal(); },
        peg$c345 = function() {
        ...
        peg$c347 = function(range) {
            return range;
          },
        peg$c348 = function(from, operator, to) {
        ...
        peg$c357 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c358 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c359 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c360 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c361 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c362 = function(key, value) {
