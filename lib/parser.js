module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c252 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c253 = "||",
        ...
        peg$c259 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c260 = "|",
        ...
        peg$c284 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c285 = "<<",
        ...
        peg$c315 = function(operator, argument) {
        ...
        peg$c326 = function(callee, nullPropagatingOperator, args) {
        ...
        peg$c327 = function(nullPropagatingOperator, args) {
                  return { 
        ...
        peg$c333 = function(range) {
                return {
                  type: "RangeMemberExpression",
                  range: range   
                }
              },
        peg$c334 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c341 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c342 = function(id, params, inheritsFrom, body) {
        ...
        peg$c349 = function(id) { return id.asGlobal(); },
        peg$c350 = function() {
        ...
        peg$c353 = function(from, operator, to) {
        ...
        peg$c360 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c361 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c362 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c363 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c364 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c365 = function(key, value) {
              return insertLocationData(new ast.Property(key, value), text(), line(), column());
            },
        peg$c366 = function(id) { return [id]; },
