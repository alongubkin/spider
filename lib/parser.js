module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c238 = function(id, init) {
            return insertLocationData(new ast.VariableDeclarator(id, extractOptional(init, 1)), text(), line(), column());
          },
        peg$c239 = "=",
        peg$c240 = { type: "literal", value: "=", description: "\"=\"" },
        peg$c241 = function(expression) { return expression; },
        peg$c242 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c243 = "extends",
        peg$c244 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c245 = function(call) {
              return call;
            },
        peg$c246 = function(id, defaultValue) {
        ...
        peg$c264 = function(specifiers, source) {
        ...
        peg$c288 = function(key, value, object, body) {
        ...
        peg$c289 = function(declarations, test, update, body) {
        ...
        peg$c290 = function(init, test, update, body) {
              return insertLocationData(new ast.ForStatement(
        ...
        peg$c319 = function(consequent, condition) {
              if (condition) {
        ...
        peg$c320 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c321 = "||",
        ...
        peg$c353 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c354 = "<<",
        ...
        peg$c380 = function(operator, argument) {
        ...
        peg$c388 = function(argument, operator) {
              if (operator) {
        ...
        peg$c391 = function(argument, operator) {
            if (operator) { 
        ...
        peg$c393 = function(operator, args) {
        ...
        peg$c396 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c400 = function(nullPropagatingOperator, property) {
                  return { 
                    type: nullPropagatingOperator === "?" ? "NullPropagatingExpression" : "MemberExpression",
                    property: property, 
                    computed: false 
        ...
        peg$c402 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c403 = function(expression) {
            return insertLocationData(new ast.SplatExpression(expression), text(), line(), column()); 
          },
        peg$c404 = function(id, params, inheritsFrom, body) {
        ...
        peg$c406 = function(params, operator, body) {
              return insertLocationData(new ast.FunctionExpression(
                null, 
                optionalList(extractOptional(params, 0)),
                body,
        ...
        peg$c411 = function(expression, item, index, array, condition) {
        ...
        peg$c414 = function(id) { return id.asGlobal(); },
        peg$c415 = function() {
        ...
        peg$c417 = function(range) {
            return range;
          },
        peg$c418 = function(from, operator, to) {
        ...
        peg$c425 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c426 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
