module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c237 = function(expression) { return expression; },
        peg$c238 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c239 = "extends",
        peg$c240 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c241 = function(call) {
              return call;
            },
        peg$c242 = function(id, defaultValue) {
        ...
        peg$c278 = function(key, value, object, body) {
        ...
        peg$c279 = function(declarations, test, update, body) {
        ...
        peg$c280 = function(init, test, update, body) {
              return insertLocationData(new ast.ForStatement(
        ...
        peg$c281 = function(identifiers) { return new ast.UseStatement(identifiers) },
        ...
        peg$c284 = function(left, assignment) { 
              if (!assignment) {
                return left;
              }
        ...
        peg$c308 = function(consequent, condition) {
              if (condition) {
        ...
        peg$c309 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c310 = "||",
        ...
        peg$c316 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c317 = "|",
        ...
        peg$c342 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c343 = "<<",
        ...
        peg$c369 = function(operator, argument) {
        ...
        peg$c377 = function(argument, operator) {
              if (operator) {
        ...
        peg$c380 = function(argument, operator) {
            if (operator) { 
        ...
        peg$c382 = function(nullPropagatingOperator, args) {
                  return { 
                    type: nullPropagatingOperator === "?" ? "NullCheckCallExpression" : "CallExpression", 
                    arguments: args 
                  };
                },
        peg$c383 = function(property) {
                  return {
        ...
        peg$c385 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c389 = function(nullPropagatingOperator, property) {
                  return { 
                    type: nullPropagatingOperator === "?" ? "NullPropagatingExpression" : "MemberExpression",
                    property: property, 
                    computed: false 
        ...
        peg$c391 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c392 = function(expression) {
            return insertLocationData(new ast.SplatExpression(expression), text(), line(), column()); 
          },
        peg$c393 = function(id, params, inheritsFrom, body) {
        ...
        peg$c394 = function(params, operator, body) {      
              return new ast.FunctionExpression(
                null,
                optionalList(extractOptional(params, 0)),
                body,
        ...
        peg$c395 = function(params, operator, body) {
              return new ast.FunctionExpression(
                null, 
                optionalList(extractOptional(params, 0)),
                body,
        ...
        peg$c400 = function(expression, item, index, array, condition) {
        ...
        peg$c403 = function(id) { return id.asGlobal(); },
        peg$c404 = function() {
        ...
        peg$c406 = function(range) {
            return range;
          },
        peg$c407 = function(from, operator, to) {
        ...
        peg$c413 = function(elements, elision) {
        ...
        peg$c414 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c415 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c416 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c417 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c418 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c419 = function(key, value) {
              return insertLocationData(new ast.Property(key, value), text(), line(), column());
            },
        peg$c420 = function(id) { return [id]; },
