module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c176 = function(declarations) {
        ...
        peg$c183 = function(expression) { return expression; },
        peg$c184 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c185 = "extends",
        peg$c186 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c187 = function(call) {
              return call;
            },
        peg$c188 = function(id) {
              return insertLocationData(
        ...
        peg$c198 = function(init, test, body) {
              return new ast.ForStatement(
        ...
        peg$c199 = function(declarations, test, update, body) {
              return new ast.ForStatement(
                new ast.VariableDeclarationStatement(declarations),
                extractOptional(test, 0),
                update,
        ...
        peg$c200 = function(init, test, update, body) {
              return new ast.ForStatement(
                extractOptional(init, 0),
                extractOptional(test, 0),
                update,
        ...
        peg$c201 = function(identifiers) { return new ast.UseStatement(identifiers) },
        peg$c202 = ":",
        peg$c203 = { type: "literal", value: ":", description: "\":\"" },
        peg$c204 = function(id) {
            return id.asPredefinedCollection();
          },
        peg$c205 = function(expression) {
              return insertLocationData(new ast.ExpressionStatement(expression), text(), line(), column());
            },
        peg$c206 = function(left, right) { return insertLocationData(new ast.AssignmentExpression(left, '=', right), text(), line(), column()); },
        peg$c207 = function(left, operator, right) { return insertLocationData(new ast.AssignmentExpression(left, operator, right), text(), line(), column()); },
        peg$c208 = "*=",
        ...
        peg$c230 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c231 = "||",
        ...
        peg$c237 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c238 = "|",
        ...
        peg$c262 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c263 = "<<",
        ...
        peg$c281 = function(operator, argument) {
        ...
        peg$c288 = function(argument, operator) {
              if (operator) {
        ...
        peg$c292 = function(callee, nullPropagatingOperator, args) {
        ...
        peg$c293 = function(nullPropagatingOperator, args) {
                  return { 
        ...
        peg$c299 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c304 = function(nullPropagatingOperator, property) {
                  return { 
                    property: property, 
                    computed: false, 
        ...
        peg$c306 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c307 = function(id, params, inheritsFrom, body) {
        ...
        peg$c314 = function(id) { return id.asGlobal(); },
        peg$c315 = function() {
        ...
        peg$c320 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c321 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c322 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c323 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c324 = function(properties) {
