module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c180 = function(declarations) {
        ...
        peg$c187 = function(expression) { return expression; },
        peg$c188 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c189 = "extends",
        peg$c190 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c191 = function(call) {
              return call;
            },
        peg$c192 = function(id) {
              return insertLocationData(
        ...
        peg$c203 = function(declarations, test, body) {
        ...
        peg$c204 = function(init, test, body) {
              return new ast.ForStatement(
        ...
        peg$c205 = function(declarations, test, update, body) {
              return new ast.ForStatement(
                new ast.VariableDeclarationStatement(declarations),
                extractOptional(test, 0),
                update,
        ...
        peg$c206 = function(init, test, update, body) {
              return new ast.ForStatement(
                extractOptional(init, 0),
                extractOptional(test, 0),
                update,
        ...
        peg$c207 = function(identifiers) { return new ast.UseStatement(identifiers) },
        peg$c208 = ":",
        ...
        peg$c212 = function(left, operator, right) { return insertLocationData(new ast.AssignmentExpression(left, operator, right), text(), line(), column()); },
        ...
        peg$c236 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c237 = "||",
        ...
        peg$c243 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c244 = "|",
        ...
        peg$c268 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c269 = "<<",
        ...
        peg$c299 = function(operator, argument) {
        ...
        peg$c306 = function(argument, operator) {
              if (operator) {
        ...
        peg$c310 = function(callee, nullPropagatingOperator, args) {
        ...
        peg$c311 = function(nullPropagatingOperator, args) {
                  return { 
        ...
        peg$c317 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c322 = function(nullPropagatingOperator, property) {
                  return { 
                    property: property, 
                    computed: false, 
        ...
        peg$c324 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c325 = function(id, params, inheritsFrom, body) {
        ...
        peg$c332 = function(id) { return id.asGlobal(); },
        peg$c333 = function() {
        ...
        peg$c336 = function(from, operator, to) {
        ...
        peg$c345 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c346 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c347 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c348 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c349 = function(properties) {
