module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c182 = function(declarations) {
        ...
        peg$c189 = function(expression) { return expression; },
        peg$c190 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c191 = "extends",
        peg$c192 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c193 = function(call) {
              return call;
            },
        ...
        peg$c206 = function(declarations, test, body) {
        ...
        peg$c207 = function(init, test, body) {
              return new ast.ForStatement(
        ...
        peg$c208 = function(declarations, test, update, body) {
              return new ast.ForStatement(
                new ast.VariableDeclarationStatement(declarations),
                extractOptional(test, 0),
                update,
        ...
        peg$c209 = function(init, test, update, body) {
              return new ast.ForStatement(
                extractOptional(init, 0),
                extractOptional(test, 0),
                update,
        ...
        peg$c210 = function(identifiers) { return new ast.UseStatement(identifiers) },
        peg$c211 = ":",
        peg$c212 = { type: "literal", value: ":", description: "\":\"" },
        peg$c213 = function(id) {
            return id.asPredefinedCollection();
          },
        peg$c214 = function(expression) {
              return insertLocationData(new ast.ExpressionStatement(expression), text(), line(), column());
            },
        peg$c215 = function(left, operator, right) { return insertLocationData(new ast.AssignmentExpression(left, operator, right), text(), line(), column()); },
        ...
        peg$c239 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c240 = "||",
        ...
        peg$c246 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c247 = "|",
        ...
        peg$c271 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c272 = "<<",
        ...
        peg$c302 = function(operator, argument) {
        ...
        peg$c309 = function(argument, operator) {
              if (operator) {
        ...
        peg$c312 = function(argument, operator) {
            if (operator) { 
        ...
        peg$c313 = function(callee, nullPropagatingOperator, args) {
        ...
        peg$c314 = function(nullPropagatingOperator, args) {
                  return { 
        ...
        peg$c320 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c325 = function(nullPropagatingOperator, property) {
                  return { 
                    property: property, 
                    computed: false, 
        ...
        peg$c327 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c328 = function(id, params, inheritsFrom, body) {
        ...
        peg$c335 = function(id) { return id.asGlobal(); },
        peg$c336 = function() {
        ...
        peg$c339 = function(from, operator, to) {
        ...
        peg$c348 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c349 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c350 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c351 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c352 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c353 = function(key, value) {
