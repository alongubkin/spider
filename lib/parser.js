module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c264 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c265 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c266 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c267 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c268 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c269 = ":",
        peg$c270 = { type: "literal", value: ":", description: "\":\"" },
        peg$c271 = function(key, value) {
              return insertLocationData(new ast.Property(key, value), text(), line(), column());
            },
        peg$c272 = function(id) { return [id]; },
