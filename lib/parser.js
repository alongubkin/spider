module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c235 = function(declarations) {
        ...
        peg$c244 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c245 = "extends",
        peg$c246 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c247 = function(call) {
              return call;
            },
        peg$c248 = function(id, defaultValue) {
        ...
        peg$c266 = function(specifiers, source) {
        ...
        peg$c274 = function(specifiers, source) {
        ...
        peg$c290 = function(key, value, object, body) {
        ...
        peg$c291 = function(declarations, test, update, body) {
        ...
        peg$c292 = function(init, test, update, body) {
              return insertLocationData(new ast.ForStatement(
        ...
        peg$c321 = function(consequent, condition) {
              if (condition) {
        ...
        peg$c322 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c323 = "||",
        ...
        peg$c329 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c330 = "|",
        ...
        peg$c355 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c356 = "<<",
        ...
        peg$c382 = function(operator, argument) {
        ...
        peg$c390 = function(argument, operator) {
              if (operator) {
        ...
        peg$c395 = function(operator, args) {
        ...
        peg$c397 = function(range) {
                return {
                  type: "RangeMemberExpression",
                  range: range   
                }
              },
        peg$c398 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c402 = function(nullPropagatingOperator, property) {
                  return { 
                    type: nullPropagatingOperator === "?" ? "NullPropagatingExpression" : "MemberExpression",
                    property: property, 
                    computed: false 
        ...
        peg$c404 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c405 = function(expression) {
            return insertLocationData(new ast.SplatExpression(expression), text(), line(), column()); 
          },
        peg$c406 = function(id, params, inheritsFrom, body) {
        ...
        peg$c407 = function(params, operator, body) {      
              return insertLocationData(new ast.FunctionExpression(
                null,
                optionalList(extractOptional(params, 0)),
                body,
        ...
        peg$c408 = function(params, operator, body) {
              return insertLocationData(new ast.FunctionExpression(
                null, 
                optionalList(extractOptional(params, 0)),
                body,
        ...
        peg$c413 = function(expression, item, index, array, condition) {
        ...
        peg$c416 = function(id) { return id.asGlobal(); },
        peg$c417 = function() {
        ...
        peg$c419 = function(range) {
            return range;
          },
        peg$c420 = function(from, operator, to) {
        ...
        peg$c426 = function(elements, elision) {
