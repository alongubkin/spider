module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c186 = function(declarations) {
        ...
        peg$c193 = function(expression) { return expression; },
        peg$c194 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c195 = "extends",
        peg$c196 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c197 = function(call) {
              return call;
            },
        ...
        peg$c213 = function(init, test, body) {
              return new ast.ForStatement(
        ...
        peg$c214 = function(declarations, test, update, body) {
              return new ast.ForStatement(
                new ast.VariableDeclarationStatement(declarations),
                extractOptional(test, 0),
                update,
        ...
        peg$c215 = function(init, test, update, body) {
              return new ast.ForStatement(
                extractOptional(init, 0),
                extractOptional(test, 0),
                update,
        ...
        peg$c216 = function(identifiers) { return new ast.UseStatement(identifiers) },
        peg$c217 = ":",
        ...
        peg$c221 = function(left, operator, right) { return insertLocationData(new ast.AssignmentExpression(left, operator, right), text(), line(), column()); },
        ...
        peg$c245 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c246 = "||",
        ...
        peg$c252 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c253 = "|",
        ...
        peg$c277 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c278 = "<<",
        ...
        peg$c308 = function(operator, argument) {
        ...
        peg$c315 = function(argument, operator) {
              if (operator) {
        ...
        peg$c318 = function(argument, operator) {
            if (operator) { 
        ...
        peg$c319 = function(callee, nullPropagatingOperator, args) {
        ...
        peg$c320 = function(nullPropagatingOperator, args) {
                  return { 
        ...
        peg$c326 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c333 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c334 = function(id, params, inheritsFrom, body) {
        ...
        peg$c341 = function(id) { return id.asGlobal(); },
        peg$c342 = function() {
        ...
        peg$c344 = function(range) {
            return range;
          },
        peg$c345 = function(from, operator, to) {
        ...
        peg$c354 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c355 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c356 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c357 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c358 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c359 = function(key, value) {
