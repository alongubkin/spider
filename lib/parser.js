module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c239 = function(expression) { return expression; },
        peg$c240 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c241 = "extends",
        peg$c242 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c243 = function(call) {
              return call;
            },
        peg$c244 = function(id, defaultValue) {
        ...
        peg$c262 = function(specifiers, source) {
        ...
        peg$c270 = function(specifiers, source) {
        ...
        peg$c279 = function(discriminant, cases) {
        ...
        peg$c286 = function(key, value, object, body) {
        ...
        peg$c287 = function(declarations, test, update, body) {
        ...
        peg$c288 = function(init, test, update, body) {
              return insertLocationData(new ast.ForStatement(
        ...
        peg$c316 = function(consequent, condition) {
              if (condition) {
        ...
        peg$c317 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c318 = "||",
        ...
        peg$c324 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c325 = "|",
        ...
        peg$c350 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c351 = "<<",
        ...
        peg$c377 = function(operator, argument) {
        ...
        peg$c385 = function(argument, operator) {
              if (operator) {
        ...
        peg$c390 = function(operator, args) {
        ...
        peg$c392 = function(range) {
                return {
                  type: "RangeMemberExpression",
                  range: range   
                }
              },
        peg$c393 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c397 = function(nullPropagatingOperator, property) {
                  return { 
                    type: nullPropagatingOperator === "?" ? "NullPropagatingExpression" : "MemberExpression",
                    property: property, 
                    computed: false 
        ...
        peg$c399 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c400 = function(expression) {
            return insertLocationData(new ast.SplatExpression(expression), text(), line(), column()); 
          },
        peg$c401 = function(id, params, inheritsFrom, body) {
        ...
        peg$c402 = function(params, operator, body) {      
              return new ast.FunctionExpression(
                null,
                optionalList(extractOptional(params, 0)),
                body,
        ...
        peg$c403 = function(params, operator, body) {
              return new ast.FunctionExpression(
                null, 
                optionalList(extractOptional(params, 0)),
                body,
        ...
        peg$c408 = function(expression, item, index, array, condition) {
        ...
        peg$c411 = function(id) { return id.asGlobal(); },
        peg$c412 = function() {
        ...
        peg$c415 = function(from, operator, to) {
        ...
        peg$c422 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c423 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c424 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c425 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c426 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c427 = function(key, value) {
              return insertLocationData(new ast.Property(key, value), text(), line(), column());
            },
        peg$c428 = function(id) { return [id]; },
