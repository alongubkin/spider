module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c200 = function(declarations) {
        ...
        peg$c208 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c209 = "extends",
        peg$c210 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c211 = function(call) {
              return call;
            },
        ...
        peg$c216 = function(id, defaultValue) {
        ...
        peg$c237 = function(key, value, object, body) {
        ...
        peg$c238 = function(declarations, test, update, body) {
        ...
        peg$c239 = function(init, test, update, body) {
              return insertLocationData(new ast.ForStatement(
        ...
        peg$c240 = function(identifiers) { return new ast.UseStatement(identifiers) },
        peg$c241 = ":",
        ...
        peg$c245 = function(left, operator, right) { return insertLocationData(new ast.AssignmentExpression(left, operator, right), text(), line(), column()); },
        ...
        peg$c269 = function(consequent, condition) {
              if (condition) {
        ...
        peg$c270 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c271 = "||",
        ...
        peg$c277 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c278 = "|",
        ...
        peg$c303 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c304 = "<<",
        ...
        peg$c334 = function(operator, argument) {
        ...
        peg$c341 = function(argument, operator) {
              if (operator) {
        ...
        peg$c344 = function(argument, operator) {
            if (operator) { 
        ...
        peg$c345 = function(callee, nullPropagatingOperator, args) {
        ...
        peg$c346 = function(nullPropagatingOperator, args) {
                  return { 
        ...
        peg$c352 = function(range) {
                return {
                  type: "RangeMemberExpression",
                  range: range   
                }
              },
        peg$c353 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c358 = function(nullPropagatingOperator, property) {
                  return { 
                    type: nullPropagatingOperator === "?" ? "NullPropagatingExpression" : "MemberExpression",
                    property: property, 
                    computed: false 
        ...
        peg$c369 = function(expression, item, index, array, condition) {
        ...
        peg$c370 = function(id) { return id.asGlobal(); },
        peg$c371 = function() {
        ...
        peg$c374 = function(from, operator, to) {
        ...
        peg$c381 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c382 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c383 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c384 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c385 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c386 = function(key, value) {
              return insertLocationData(new ast.Property(key, value), text(), line(), column());
            },
        peg$c387 = function(id) { return [id]; },
