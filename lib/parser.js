module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c174 = function(declarations) {
        ...
        peg$c182 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c183 = "extends",
        peg$c184 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c185 = function(call) {
              return call;
            },
        ...
        peg$c191 = function(test, consequent) {
        ...
        peg$c195 = function(init, test, body) {
              return new ast.ForStatement(
        ...
        peg$c196 = function(declarations, test, update, body) {
              return new ast.ForStatement(
                new ast.VariableDeclarationStatement(declarations),
                extractOptional(test, 0),
                update,
        ...
        peg$c197 = function(init, test, update, body) {
              return new ast.ForStatement(
                extractOptional(init, 0),
                extractOptional(test, 0),
                update,
        ...
        peg$c198 = function(id) { return new ast.UseStatement(id) },
        peg$c199 = function(expression) {
              return insertLocationData(new ast.ExpressionStatement(expression), text(), line(), column());
            },
        peg$c200 = function(left, right) { return insertLocationData(new ast.AssignmentExpression(left, '=', right), text(), line(), column()); },
        peg$c201 = function(left, operator, right) { return insertLocationData(new ast.AssignmentExpression(left, operator, right), text(), line(), column()); },
        peg$c202 = "*=",
        ...
        peg$c224 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c225 = "||",
        ...
        peg$c231 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c232 = "|",
        ...
        peg$c256 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c257 = "<<",
        ...
        peg$c275 = function(operator, argument) {
        ...
        peg$c282 = function(argument, operator) {
              if (operator) {
        ...
        peg$c286 = function(callee, nullPropagatingOperator, args) {
        ...
        peg$c287 = function(nullPropagatingOperator, args) {
                  return { 
        ...
        peg$c293 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c298 = function(nullPropagatingOperator, property) {
                  return { 
                    property: property, 
                    computed: false, 
        ...
        peg$c301 = function(id, params, inheritsFrom, body) {
        ...
        peg$c308 = function(id) { return id.asGlobal(); },
        peg$c309 = function() {
        ...
        peg$c314 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c315 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c316 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c317 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c318 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c319 = ":",
        peg$c320 = { type: "literal", value: ":", description: "\":\"" },
        peg$c321 = function(key, value) {
              return insertLocationData(new ast.Property(key, value), text(), line(), column());
            },
        peg$c322 = function(id) { return [id]; },
