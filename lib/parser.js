module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c251 = function(id, params, inheritsFrom, body) {
              return insertLocationData(
                  new ast.FunctionDeclarationStatement(id, optionalList(extractOptional(params, 0)), body, inheritsFrom), 
                text(), line(), column());
            },
        peg$c252 = "extends",
        peg$c253 = { type: "literal", value: "extends", description: "\"extends\"" },
        peg$c254 = function(call) {
              return call;
            },
        peg$c255 = function(id, defaultValue) {
        ...
        peg$c273 = function(specifiers, source) {
        ...
        peg$c281 = function(specifiers, source) {
        ...
        peg$c297 = function(item, index, array, body) {
        ...
        peg$c298 = function(key, value, object, body) {
        ...
        peg$c299 = function(declarations, test, update, body) {
        ...
        peg$c300 = function(init, test, update, body) {
              return insertLocationData(new ast.ForStatement(
        ...
        peg$c329 = function(consequent, condition) {
              if (condition) {
        ...
        peg$c330 = function(first, rest) { return buildLogicalExpression(first, rest); },
        peg$c331 = "||",
        ...
        peg$c337 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c338 = "|",
        ...
        peg$c363 = function(first, rest) { return buildNullCoalescingExpression(first, rest); },
        peg$c364 = "<<",
        ...
        peg$c390 = function(operator, argument) {
        ...
        peg$c398 = function(argument, operator) {
              if (operator) {
        ...
        peg$c401 = function(argument, operator) {
            if (operator) { 
        ...
        peg$c403 = function(operator, args) {
        ...
        peg$c405 = function(range) {
                return {
                  type: "RangeMemberExpression",
                  range: range   
                }
              },
        peg$c406 = function(nullPropagatingOperator, property) {
                  return {
        ...
        peg$c410 = function(nullPropagatingOperator, property) {
                  return { 
                    type: nullPropagatingOperator === "?" ? "NullPropagatingExpression" : "MemberExpression",
                    property: property, 
                    computed: false 
        ...
        peg$c412 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c413 = function(expression) {
            return insertLocationData(new ast.SplatExpression(expression), text(), line(), column()); 
          },
        peg$c414 = function(id, params, inheritsFrom, body) {
        ...
        peg$c415 = function(params, operator, body) {      
              return insertLocationData(new ast.FunctionExpression(
                null,
                optionalList(extractOptional(params, 0)),
                body,
        ...
        peg$c416 = function(params, operator, body) {
              return insertLocationData(new ast.FunctionExpression(
                null, 
                optionalList(extractOptional(params, 0)),
                body,
        ...
        peg$c421 = function(expression, item, index, array, condition) {
        ...
        peg$c424 = function(id) { return id.asGlobal(); },
        peg$c425 = function() {
        ...
        peg$c427 = function(range) {
            return range;
          },
        peg$c428 = function(from, operator, to) {
