module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c343 = function(id, params, inheritsFrom, body) {
        ...
        peg$c350 = function(id) { return id.asGlobal(); },
        peg$c351 = function() {
        ...
        peg$c353 = function(range) {
            return range;
          },
        peg$c354 = function(from, operator, to) {
        ...
        peg$c361 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c362 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c363 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c364 = function() { 
               return  new ast.ObjectExpression([]); 
             },
        peg$c365 = function(properties) {
               return insertLocationData(new ast.ObjectExpression(properties), text(), line(), column());
             },
        peg$c366 = function(key, value) {
              return insertLocationData(new ast.Property(key, value), text(), line(), column());
            },
        peg$c367 = function(id) { return [id]; },
