System.register("LogicalExpression", [], function() {
  "use strict";
  var __moduleName = "LogicalExpression";
  function require(path) {
    return $traceurRuntime.require("LogicalExpression", path);
  }
  "use strict";
  (function() {
